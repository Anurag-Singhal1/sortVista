...
export default class SortingVisualizer extends React.Component {
    ...
    resetArray() {                                       // generate new array button 
      ...
      for (let i = 0; i < NUMBER_OF_ARRAY_BARS; i++) {
        array.push(randomIntFromInterval(50,500));      // bar length - push a random value b/w 50 & 500
      }
      this.setState({array});
    }
    ...
    render(){
        ...
        <div className="navbar w-full h-20 bg-dark-cyan">
          <div className="btnleft absolute ">
            <button className=' px-3 py-2 bg-dark-cyan hover:bg-lightice hover:text-dark-cyan rounded-md mx-3 my-4 ring-4 ring-pink-100 ring-inset' onClick={()=>this.resetArray()}>Generate New Array</button>

              {/* all 6 sorting algos */}
            <button className=' px-2 py-2 bg-teal-500 hover:bg-lightice hover:text-dark-cyan rounded-md mx-3 my-4' onClick={()=>this.mergeSort()}>Merge Sort</button>
            <button className=' px-2 py-2 bg-cyan-500 hover:bg-lightice hover:text-dark-cyan rounded-md mx-3 my-4' onClick={()=>this.quickSort()}>Quick Sort</button>
            <button className=' px-2 py-2 bg-sky-400 hover:bg-lightice hover:text-dark-cyan rounded-md mx-3 my-4' onClick={()=>this.heapSort()}>Heap Sort</button>
            <button className=' px-2 py-2 bg-blue-400 hover:bg-lightice hover:text-dark-cyan rounded-md mx-3 my-4' onClick={()=>this.insertionSort()}>Insertion Sort</button>
            <button className=' px-2 py-2 bg-indigo-400 hover:bg-lightice hover:text-dark-cyan rounded-md mx-3 my-4' onClick={()=>this.bubbleSort()}>Bubble Sort</button>
            <button className=' px-2 py-2 bg-pink-400 hover:bg-lightice hover:text-dark-cyan rounded-md mx-3 my-4' onClick={()=>this.selectionSort()}>Selection Sort</button>

          </div>

          <div className="btnright pt-4 pb-4 mr-3 absolute right-3 top-1.5">

            <div className="numberofBars inline m-3 p-3 bg-dark-cyan ring-4 ring-pink-100 ring-inset rounded-md">
            ...
            <div className="animationSpeed inline m-3 p-3 bg-dark-cyan ring-4 ring-pink-100 ring-inset rounded-md">
